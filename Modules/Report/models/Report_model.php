...
class Report_model extends Model
{
    ...
    public function getAllSurvay($search = []){
        ...
        $builder->select("
            ...
            max(LH_interview_land.interview_user) as interview_user,
            max(LH_interview_land.interview_code) as interview_code,
            max(LH_interview_land.interview_year) as interview_year,
            max(LH_interview_land.interview_land_utilization_type) as interview_land_utilization_type,
            max(LH_interview_land.interview_land_use_type) as interview_land_use_type,
            max(LH_interview_land.intervew_land_water_process) as intervew_land_water_process,
            max(LH_house_person.person_id) as person_id,

            max(LH_users.fullname) as user_name,
            ...
            max(CODE_PROJECTVILLAGE.BasinName) as BasinName,
            ...
            max(LH_house_person.person_type_number) as person_type_number,
            ...
            max(CODE_POSSESSRIGHT.name) as land_possess,
    ...
    public function getSurvayDetail($land){
        ...
        $builder->join('CODE_PRODUCTTYPE', 'CODE_PRODUCTTYPE.Code = CODE_PRODUCT.TypeCode','left');
        $builder->join('CODE_PRODUCTGROUP', 'CODE_PRODUCTGROUP.Code = CODE_PRODUCT.GroupCode','left');
